  ...
  return (
    <article className='post-card'>
      ...
      <menu className='post-menu'>
        <li>
          <button className='post-menu-button' aria-label='Like the post'>
        ...
        <li>
          ...
          >
            ...
            <span className='post-menu-label'>
              {isAuthenticated ? '2 comments' : 'You have to login to see the comments'}
            </span>
            {isAuthenticated &&
      ...
      {isCommentsOpen &&
        <ol className='post-comments-list'>
          ...
          <li>
            <Comment text='Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet' />
          </li>
        </ol>
      }
